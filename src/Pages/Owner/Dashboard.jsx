 ...
 const fetchDasboardData = async () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      ...
      {/* Dashboard Cards */}
      <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 max-w-4xl mx-auto'>
      ...
      <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
        ...
        <div className='p-4 md:p-6 border border-borderColor rounded-md w-full max-w-sm'>
          <h1 className='text-lg font-medium '>Monthly Revenue</h1>
          <p className='text-gray-500 font-semibold '>This month's earnings</p>
          <p className='text-2xl font-semibold mt-4 text-primary' >{currency}{data.monthlyRevenue}</p>
        </div>
      </div>
    </div>
  );
