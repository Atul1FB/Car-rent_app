            ...
            {cars.map((car, index) => (
              <tr key={index} className="border-t border-borderColor">
                ...
                <td className='p-3 max-md:hidden'>
                  <span className={`px-3 py-1 rouded-full text-xs ${car.isAvaliable?" border-rounded-full bg-green-200 text-green-800": "bg-red-200 text-red-800  "}`}>
                    {car.isAvaliable?"Available":"Unavailble"}
